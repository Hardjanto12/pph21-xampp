...
<body>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-4">
                        <!-- FORM PENCARIAN -->
                        <div class="pb-3">
                            <form class="d-flex" action="{{ url('mgj/selectmgj') }}" method="get">
            ...
            <table class="table table-bordered table-striped table-hover table-small text-center">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->name }}</td>
                        <td>
                            <a class="btn btn-primary btn-sm" onclick="selectMgj([
                                '{{ trim($item->mgj) }}',
                                '{{ trim($item->name) }}',
                                '{{ trim($item->ktg) }}'
                            ])" id="btnSelect">Select</a>
                        </td>
                    </tr>
                    <?php $i++ ?>
                    @endforeach
    ...
    <script>
        function selectMgj(mgjdata) {
            // alert(mgjdata[0]);
        // console.log(mgjdata);
        window.opener.popupCallbackmgj(mgjdata); //Call callback function
