...
<body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-4">
                    <!-- FORM PENCARIAN -->
                    <div class="pb-3">
                        <form class="d-flex" action="{{ url('asr/selectasr') }}" method="get">
        ...
        <table class="table table-bordered table-striped table-hover table-small text-center" >
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $item->name }}</td>
                    <td>
                        <a class="btn btn-primary btn-sm" onclick="selectAsr('{{ trim($item->asr) }}')" id="btnSelect">Select</a>
                    </td>
                </tr>
                <?php $i++ ?>
                @endforeach
  ...
  <!-- Bootstrap JavaScript Libraries -->
    ...
    <script>
    function selectAsr(asrdata) {
        window.opener.popupCallbackasr(asrdata); //Call callback function
