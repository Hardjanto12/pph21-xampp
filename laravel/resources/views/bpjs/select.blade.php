...
<body>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col">
                        <!-- FORM PENCARIAN -->
                        <div class="pb-3">
                            <form class="d-flex" action="{{ url('bpjs/selectbpjs') }}" method="get">
            ...
            <table class="table table-bordered table-striped table-hover table-small text-center">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->name }}</td>
                        <td>
                            <a class="btn btn-primary btn-sm" onclick="selectBpjs('{{ trim($item->bpjs) }}')" id="btnSelect">Select</a>
                        </td>
                    </tr>
                    <?php $i++ ?>
                    @endforeach
    ...
    <script>
        function selectBpjs(bpjsdata) {
            window.opener.popupCallbackbpjs(bpjsdata); //Call callback function
