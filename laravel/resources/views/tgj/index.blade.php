        ...
        <div class="container">
            <div class="row">
                <div class="col-2">
                    <!-- TOMBOL TAMBAH DATA -->
                    <div class="pb-3">
                        <a href='{{ url('tgj/create') }}' class="btn btn-md btn-primary">
                ...
                <div class="col-4">
                    <!-- FORM PENCARIAN -->
                    <div class="pb-3">
                        <form class="d-flex" action="{{ url('tgj') }}" method="get">
            ...
            <tbody>
                ...
                @foreach ($data as $item)
                    <tr>
                        ...
                        data-bs-target="#details" data-id="{{ '/tgj/'.$item->nojnl }}">
                        Detail
                    </button> --}}
                            <a href='{{ url('tgj/' . trim($item->nojnl) . '/edit') }}'
                                class="btn btn-warning btn-sm">Edit</a>
                            <form onsubmit="return confirm('Yakin akan menghapus data {{ trim($item->nojnl) }}?')"
                                class="d-inline" action="{{ url('tgj/' . trim($item->nojnl)) }}" method="post">
                                @csrf
                                @method('DELETE')
