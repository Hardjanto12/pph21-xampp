    ...
    <div class="container">
        <div class="row">
            <div class="col-2">
                <!-- TOMBOL TAMBAH DATA -->
                <div class="pb-3">
                    <a href='{{ url('ktg/create') }}' class="btn btn-md btn-primary">
            ...
            <div class="col-4">
                <!-- FORM PENCARIAN -->
                <div class="pb-3">
                    <form class="d-flex" action="{{ url('ktg') }}" method="get">
    ...
    <table class="table table-bordered table-striped table-hover table-small text-center" >
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $item->name }}</td>
                <td>
                    <a href='{{ url('ktg/'.trim($item->ktg).'/edit') }}' class="btn btn-warning btn-sm">Edit</a>
                    <form onsubmit="return confirm('Yakin akan menghapus data?')" class="d-inline" action="{{ url('ktg/'.$item->ktg) }}" method="post">
                        @csrf
                        @method('DELETE')
