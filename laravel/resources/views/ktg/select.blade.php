...
<head>
  <title>Pilih Kategori Penghasilan</title>
  <!-- Required meta tags -->
  <meta charset="utf-8">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-4">
                    <!-- FORM PENCARIAN -->
                    <div class="pb-3">
                        <form class="d-flex" action="{{ url('ktg/selectktg') }}" method="get">
        ...
        <table class="table table-bordered table-striped table-hover table-small text-center" >
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $item->name }}</td>
                    <td>
                        <a class="btn btn-primary btn-sm" onclick="selectKtg('{{ trim($item->ktg) }}')" id="btnSelect">Select</a>
                    </td>
                </tr>
                <?php $i++ ?>
                @endforeach
...
<script>
    function selectKtg(ktgdata) {
        window.opener.popupCallbackktg(ktgdata); //Call callback function
