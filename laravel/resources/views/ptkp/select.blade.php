        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-4">
                    <!-- FORM PENCARIAN -->
                    <div class="pb-3">
                        <form class="d-flex" action="{{ url('ptkp/selectptkp') }}" method="get">
        ...
        <table class="table table-bordered table-striped table-hover table-small text-center" >
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $item->name }}</td>
                    <td>
                        <a class="btn btn-primary btn-sm" onclick="selectPtkp('{{ trim($item->ptkp) }}')" id="btnSelect">Select</a>
                    </td>
                </tr>
                <?php $i++ ?>
                @endforeach
...
<script>
    function selectPtkp(ptkpdata) {
        window.opener.popupCallbackptkp(ptkpdata); //Call callback function
