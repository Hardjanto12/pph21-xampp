...
<body>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-4">
                        <!-- FORM PENCARIAN -->
                        <div class="pb-3">
                            <form class="d-flex" action="{{ url('kry/selectkry') }}" method="get">
            ...
            <table class="table table-bordered table-striped table-hover table-small text-center">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->name }}</td>
                        <td>
                            <a class="btn btn-primary btn-sm" onclick="selectKry([
                                '{{ trim($item->kry) }}',
                                '{{ trim($item->nik) }}',
                                '{{ trim($item->name) }}'
    ...
    <script>
        function selectKry(krydata) {
            // alert(krydata);
        // console.log(krydata);
        window.opener.popupCallbackkry(krydata); //Call callback function
