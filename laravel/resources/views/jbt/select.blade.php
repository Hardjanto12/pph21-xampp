        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-4">
                    <!-- FORM PENCARIAN -->
                    <div class="pb-3">
                        <form class="d-flex" action="{{ url('jbt/selectjbt') }}" method="get">
        ...
        <table class="table table-bordered table-striped table-hover table-small text-center" >
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $item->name }}</td>
                    <td>
                        <a class="btn btn-primary btn-sm" onclick="selectJbt('{{ trim($item->jbt) }}')" id="btnSelect">Select</a>
                    </td>
                </tr>
                <?php $i++ ?>
                @endforeach
...
<script>
    function selectJbt(jbtdata) {
        window.opener.popupCallbackjbt(jbtdata); //Call callback function
